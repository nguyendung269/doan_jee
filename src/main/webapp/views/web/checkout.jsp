						  ...
						  <div class="panel-body">
							<div class="table-responsive">
							  <table class="table table-bordered">
								...
								<tbody>
								  <tr>
									<td class="text-center"><a href="product.html"><img width="60px" src="image/catalog/demo/product/replacement/10.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail"></a></td>
